...
const electronics = () => {
  return (
    <div><div><section className="text-gray-400 bg-gray-900 body-font">
      ...
      <div className="flex flex-wrap -m-4">
        ...
        <div className="lg:w-1/4 md:w-1/2 p-4 w-full cursor-pointer shadow-lg">
          <a className="block relative rounded overflow-hidden">
            <Image alt="ecommerce" className="object-cover w-full  h-full  block" src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcTrmB9uf0cE7r-CN_J_bTNZK-RWGl4GHn_MZGP83tWTdJZ6WrJNRi3jM9ErtVUF1PPvUogBknDZLxRGHspeWS4b1tFenbvu6V8qEokfApiRDSyCn_xEIZds&usqp=CAE" width={420} height={260} / >
          </a>
          <div className="mt-4">
