  ...
  return (
    <div>
        <div className='flex flex-col md:flex-row md:justify-start justify-between items-center py-2 shadow-xl' >
           ...
           <Link href={'/'}><a><Image src="/DomDex.png" alt="logo" width={99} height={99} /></a></Link>
            </div>
            <div className="nav">
                <ul className="flex items-center space-x-2 font-bold md:text-x">
                    ...
                    <Link href={'/about'} ><a><li>About</li> </a></Link> </div>
                    <div className='text-sm sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4' >
                    <Link href={'/contact'} ><a><li>Contact</li> </a></Link></div>
                    <div className='text-sm sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4' >
                    <Link href={'/products'} ><a><li>Products</li> </a></Link></div>
                    <div className='text-sm sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4' >&nbsp;</div>
